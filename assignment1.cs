...
namespace Bme121
{
    ...
    static partial class Program
    {
        ...
        static void Main( )
        {
            ...
            // Used an array of 'Player' objects to hold information about the players.
            // Pass one 'Player' object to methods needing to use player name, colour, or symbol in 'WriteLine' messages or board operation.
            // The array aspect allows to use the index to keep track or whose turn it is.
